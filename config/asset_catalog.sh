...
asset_count_register blogs              "SELECT COUNT(*) FROM BlogsEntry WHERE groupId=__GID__ AND ctCollectionId=0 AND status=0 __DATE_FILTER__" "modifiedDate"
asset_count_register calendar           "SELECT COUNT(*) FROM CalendarBooking WHERE groupId=__GID__ AND ctCollectionId=0 AND status=0 __DATE_FILTER__" "modifiedDate"
asset_count_register categories         "SELECT COUNT(*) FROM AssetCategory WHERE groupId=__GID__ AND ctCollectionId=0 AND status=0 __DATE_FILTER__" "modifiedDate"
...
asset_count_register documents_and_media "SELECT COUNT(*) FROM DLFileEntry fe JOIN DLFileVersion fv ON fv.fileEntryId=fe.fileEntryId AND fv.version=fe.version AND fv.ctCollectionId=0 AND fv.status=0 WHERE fe.groupId=__GID__ AND fe.repositoryId=fe.groupId AND fe.ctCollectionId=0 __DATE_FILTER__" "fe.modifiedDate"
